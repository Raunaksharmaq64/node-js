...
// body parser ka use . now since we use express we dontneed to create chunks and then print it. now we can use body parser for doing same things . but order ko dhyan mai rkha hoga

app.use(bodyParser.urlencoded());

// after submit the post request handling
app.post("/contact-me",(req,res,next)=>{
  console.log(" adding post middleware",req.url,req.body,req.method);
